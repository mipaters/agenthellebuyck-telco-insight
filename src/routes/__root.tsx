...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Agent Hellebuyck" },
      ...
      { name: "twitter:title", content: "Retention Cockpit · Agent Hellebuyck Interactions Analytics" },
      { name: "twitter:description", content: "Predict, explain and save every subscriber worth saving — Agent Hellebuyck retention cockpit powered by real-time interaction analytics." },
