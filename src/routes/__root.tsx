...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Rogers Wireless" },
      ...
      { name: "twitter:title", content: "Retention Cockpit · Rogers Wireless Interactions Analytics" },
      { name: "twitter:description", content: "Predict, explain and save every subscriber worth saving — Rogers Wireless retention cockpit powered by real-time interaction analytics." },
