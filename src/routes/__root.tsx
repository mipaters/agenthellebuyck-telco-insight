...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Churn Reduction Agent Assist" },
      ...
      { name: "twitter:title", content: "Retention Cockpit · Churn Reduction Agent Assist Interactions Analytics" },
      { name: "twitter:description", content: "Predict, explain and save every subscriber worth saving — Churn Reduction Agent Assist retention cockpit powered by real-time interaction analytics." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b8da0112-8d07-4b00-b816-b0b712fc6fe1" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b8da0112-8d07-4b00-b816-b0b712fc6fe1" },
    ],
    links: [
