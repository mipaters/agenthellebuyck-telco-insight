...
export const Route = createFileRoute("/brief")({
  head: () => ({
    meta: [
      { title: "Subscriber 360 · Pre-call Brief · Churn Reduction Agent Assist" },
      { name: "description", content: "Pre-call screen-pop with churn score, SHAP attribution, and full Subscriber 360 for Churn Reduction Agent Assist retention agents." },
      { property: "og:title", content: "Subscriber 360 · Churn Reduction Agent Assist" },
